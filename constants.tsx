...
export const COINS = ['BTC', 'ETH', 'SOL', 'XRP', 'DOGE', 'BNB', 'LINK'];
export const SESSIONS = ['London', 'NY', 'Asia'];
export const TIMEFRAMES = ['1m', '5m', '15m', '1H', '4H', 'Daily'];

export const SMC_DEFINITIONS = [
  {
    title: 'Premium / Discount',
    description: 'Using Fibonacci 0.5 level to identify if price is in a selling zone (Premium) or buying zone (Discount).'
  },
  {
    title: 'Liquidity Sweep',
    description: 'A run on stops (old highs or lows) before the intended move.'
  },
  {
    title: 'MSS (Market Structure Shift)',
    description: 'A change in trend indicated by the breaking of a significant swing high or low.'
  },
  {
    title: 'FVG (Fair Value Gap)',
    description: 'A three-candle sequence where price moves so fast it leaves an inefficiency or gap.'
  },
  {
    title: 'Order Block (OB)',
    description: 'A candle that marks where big institutions have placed significant orders.'
  },
  {
    title: 'BOS (Break of Structure)',
    description: 'A continuation move breaking a swing point in the direction of the trend.'
  }
];
